...
from py_abm.runners.pso import PymooPSORunnerABM, PySwarmsPSORunnerABM
...
if __name__ == '__main__':
    ...
    if topology is None:
        runner = PymooPSORunnerABM(Market.from_str(market),
        ...
        runner = PySwarmsPSORunnerABM(Market.from_str(market),
                                      OptimizationType.from_str(opt),
                                      time_steps=ts,
                                      mc_runs=mcruns,
                                      objectives=[Objective.RMSE],
