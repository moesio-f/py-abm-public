...
class ProcessHandler:
    ...
    def results(self) -> entities.ABMJarOutput:
        ...
        assert objectives is not None, output
        assert market is not None, output
        assert market.group('market') == self._market.value, output
        assert len(objectives.groups()) == len(entities.Objective), output
